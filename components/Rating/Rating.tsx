...
export const Rating = forwardRef(({isEditable = false, error, rating, setRating, children, tabIndex, ...props }: RatingProps, ref: ForwardedRef<HTMLDivElement>): JSX.Element => {
